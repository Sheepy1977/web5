...
if ($adminLevel==6)
{
	...
	$sql="select * ,projectSchedule.comment as schComment from projectSchedule,projectList  where timeStart <= '$today' and timeEnd >= '$today' and projectSchedule.pid=projectList.pid and projectList.archive=0 order by timeEnd";
	$ok=mysql_query($sql);
	$totalItems=mysql_num_rows($ok);
}
$ok=mysql_query($sql);
$tt=1;
if ($uid!=0) echo "<ul style='list-style:none;'>"; else echo "<ul><li>&nbsp;</li><li>&nbsp;</li><li>&nbsp;</li><li>&nbsp;</li>";
